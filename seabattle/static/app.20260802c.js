...
function renderRingball(mount, s){
  ...
  function draw(){
    ...
    // направление полёта во время отсчёта
    if(countdown > 0){
      ...
      const label = countdown >= 1 ? String(Math.ceil(countdown)) : 'Старт!';
      ctx.save();
      ctx.font = "800 72px Syne, sans-serif";
      ctx.textAlign = 'center';
      ctx.textBaseline = 'middle';
      ctx.fillStyle = lightAlpha(c.ring, countdown >= 1 ? 0.9 : 0.75);
