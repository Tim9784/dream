const GAME_ICONS = {
  ...
  blik: `<svg viewBox="0 0 24 24" aria-hidden="true"><defs><mask id="ounoLogoMask"><rect width="24" height="24" fill="#fff"/><g transform="rotate(-34 12 12)" fill="#000"><text x="12" y="14.2" text-anchor="middle" font-family="Arial Black,Impact,Haettenschweiler,sans-serif" font-size="7.2" font-weight="900" letter-spacing="-1.1" font-style="italic">UNO</text></g></mask></defs><ellipse cx="12" cy="12" rx="10.2" ry="7.35" transform="rotate(-34 12 12)" fill="currentColor" mask="url(#ounoLogoMask)"/><ellipse cx="12" cy="12" rx="10.2" ry="7.35" transform="rotate(-34 12 12)" fill="none" stroke="currentColor" stroke-width="1.35" opacity=".95"/></svg>`,
...
// btnLogoutCancel убран из разметки — оставляем только Отмена / Выйти
