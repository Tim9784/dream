const GAME_ICONS = {
  ...
  blik: `<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><ellipse cx="12" cy="12" rx="9.2" ry="7.1" transform="rotate(-32 12 12)" stroke="currentColor" stroke-width="1.85"/><ellipse cx="12" cy="12" rx="6.4" ry="4.8" transform="rotate(-32 12 12)" stroke="currentColor" stroke-width="1.35" opacity=".5"/><ellipse cx="12" cy="12" rx="2.15" ry="3.05" transform="rotate(-32 12 12)" stroke="currentColor" stroke-width="2.1"/><circle cx="7.2" cy="8.1" r="1.05" fill="currentColor" stroke="none" opacity=".85"/><circle cx="16.8" cy="15.9" r="1.05" fill="currentColor" stroke="none" opacity=".55"/></svg>`,
...
if($('btnLogoutCancel')) $('btnLogoutCancel').onclick = closeLogoutModal;
